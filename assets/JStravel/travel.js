...
const placeItem = $('.city-container')
const tourismIMG = $('.container__tourism')
...
const app = {
        ...
        renderBg :function (){
                const bgCategory = $$('.city-container__category')
                ...
                const bgContinents = $$('.city-container__continents')
        ...
        handleEvent : function () {
                advanced.onclick =() => {
                        advanced.style.backgroundColor = 'var(--green-color)'
                        quick.style.backgroundColor = 'var(--color-main)'
                }


                quick.onclick =() => {
                        advanced.style.backgroundColor = 'var(--color-main)'
                        quick.style.backgroundColor = 'var(--green-color)'
                }
